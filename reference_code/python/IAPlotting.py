...
def main():
    # Load data from CSV
    csv_file = 'PlottingData24104PoseidaHATag.csv'
    ...
    plot_type = input("Enter plot type (box, violin, scatter, bar): ").strip().lower()
    ...
    if plot_type == 'box':
        ...
        print("Invalid plot type. Please choose from 'box', 'violin', 'scatter', 'bar'.")
