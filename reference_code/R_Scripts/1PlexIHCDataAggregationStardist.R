...
path.det = "C://Analysis_Studies//22-883 Rome Line1 QP//detection results"
path.ano = "C://Analysis_Studies//22-883 Rome Line1 QP//annotation results"
setwd(path.det)
...
for(f in 1:length(filelist)){
  ...
  Intensity <- mean(Positive$DAB..Cell..Mean)
...
write.csv(DataDraft,paste("22-883 Line1 Data",f,".csv"))
